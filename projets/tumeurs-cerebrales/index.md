...
![Architecture modifiée YOLOv11n avec attention PSA](photos/Graph.png)
...
![Courbes d'entraînement et métriques de validation](photos/Courbes.png)
...
![Comparaison mAP@50 par classe pathologique](photos/Table.png)
...
![Matrice de confusion YOLOv11n-PSA](photos/matrice_confusion.png)
